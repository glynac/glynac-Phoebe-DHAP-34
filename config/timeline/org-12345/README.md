# Black Diamond Timeline Configuration - Organization org-12345

## Overview

This directory contains the canonical timeline event configuration for Black Diamond wealth management data for organization **org-12345**. It implements **Phase 1** of the Black Diamond event timeline (12 core events).
...
cp -r timeline/org-12345 timeline/org_{YOUR_ORG_ID}

# Example:
cp -r timeline/org-12345 timeline/org_29a436a3_b5de_4afd_9c7a_059246c5a681
```
